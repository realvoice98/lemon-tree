...
document.addEventListener('DOMContentLoaded', function() {
  ...
  rows.forEach(function(row) {
    row.addEventListener('click', function() {
      ...
      const gender = this.querySelector('.sex_client').textContent;
      ...
      var genderInput = document.querySelector('.inputbox.sex');
      ...
      const url = 'http://localhost:8001/admin/client_list/reserv_info'; // 서버의 API 엔드포인트
